export default function Stepper(){
  ...
  return (
    <div className="mx-auto flex justify-end items-end border border-green-500">
      <ol className="flex items-center w-full ">
          ...
          <li className=" border-red-500 flex w-full items-center after:content-[''] after:w-full after:h-1 after:border-b after:border-gray-100 after:border-4 after:inline-block dark:after:border-gray-700">
          ...
          <li className="flex border-red-500 items-center w-full">
              <span className="flex items-center justify-center w-10 h-10 bg-gray-100 rounded-full lg:h-12 lg:w-12 dark:bg-gray-700 shrink-0">
